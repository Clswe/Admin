<template>
  <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div
      class="container flex items-center justify-between md:justify-end h-full px-6 mx-auto text-blue-600 dark:text-blue-300"
    >
      <!-- Mobile hamburger -->
      <button
      ...
      <ul class="flex items-center flex-shrink-0 space-x-6">
        ...
        <NotificationsMenu
          ...
          @closeNotificationsMenu="isNotificationsMenuOpen = false"
        />
        <!-- Profile menu -->
        <ProfileMenu
          :is-profile-menu-open="isProfileMenuOpen"
          @toggleProfileMenu="toggleProfileMenu"
          @closeProfileMenu="isProfileMenuOpen = false"
        />
      </ul>
    </div>
  </header>
